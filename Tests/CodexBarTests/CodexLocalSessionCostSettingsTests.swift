...
struct CodexLocalSessionCostSettingsTests {
    ...
    func `codex exposes usage and cookie pickers`() throws {
        ...
        #expect(usagePicker.subtitle == "Controls live session and weekly quota fetching.")
        ...
        #expect(localLedgerToggle.title == "Session costs")
        #expect(localLedgerToggle.subtitle == "Tracks costs from Codex sessions on this Mac.")
